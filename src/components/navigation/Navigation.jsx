  ...
  return (
    ...
    >
        ...
        {boards ? (
          <ul>
            ...
            <div
              ...
              className={
                theme === "light" ? "nav__board-name light" : "nav__board-name"
              }
            >
              <img
                className="nav__board-icon"
      ...
      <div className="nav__mode-sidebar">
        <div
          className={
            theme === "light" ? "nav__mode-toggle light" : "nav__mode-toggle"
          }
        >
        ...
        <div
          ...
          className={
            theme === "light" ? "nav__hide-sidebar light" : "nav__hide-sidebar"
          }
        >
