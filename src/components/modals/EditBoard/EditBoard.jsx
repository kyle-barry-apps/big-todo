  ...
  return (
    <div className='modal-container' ref={modal_ref}>
      ...
      <div className='addBoard__name-container'>
        ...
        <input value={updatedBoard.name} onChange={(e) => setUpdatedBoard({...updatedBoard, name: e.target.value})} className='addBoard__input' type="text" placeholder='e.g. Web Design' />
      ...
      <div onClick={editBoard} className="btn add-new-board">Save Changes</div>
    </div>
  )
}
